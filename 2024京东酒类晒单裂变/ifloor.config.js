...
module.exports = {
  ...
  // previewUrl: 'https://pro.m.jd.com/mall/active/puMw46gRgkDKJdKNTtdGvnFAXUx/index.html' /*输入任意有效通天塔活动链接*/,
  previewUrl: 'https://pro.m.jd.com/mall/active/45q3GAyqjkeDmevru5KmGgghj8NG/index.html?__ifloor_preview__=1' /*输入任意有效通天塔活动链接*/,
  plugins: [
    ['./ifloor-isv-plugin']
  ],
